...
public class HuiYuanFrame extends JFrame {
	...
	public HuiYuanFrame() {
		...
		button_3.setBounds(356, 105, 93, 23);
		contentPane.add(button_3);
		
		JButton button_4 = new JButton("查看该会员预定场馆情况");
		button_4.setBounds(241, 58, 208, 23);
		contentPane.add(button_4);
		
		JLabel label = new JLabel("会员查找（请输入会员姓名）：");
		label.setBounds(10, 109, 209, 15);
		contentPane.add(label);
		
		textField = new JTextField();
		textField.setBounds(181, 106, 141, 21);
		contentPane.add(textField);
		textField.setColumns(10);
		
		JLabel label_1 = new JLabel("会员信息列表：");
		label_1.setBounds(10, 152, 157, 15);
		contentPane.add(label_1);
		
		JButton button_5 = new JButton("会员卡充值");
		button_5.setBounds(10, 58, 106, 23);
		contentPane.add(button_5);
		
		JButton button_6 = new JButton("会员卡挂失");
		button_6.setBounds(126, 58, 106, 23);
		...
		scrollBar.setBounds(734, 188, 17, 80);
		contentPane.add(scrollBar);
		
		JLabel label_2 = new JLabel("请管理员注意：");
		label_2.setFont(new Font("宋体", Font.PLAIN, 18));
		label_2.setBounds(505, 14, 157, 38);
		contentPane.add(label_2);
		
		JLabel label_3 = new JLabel("保证会员信息安全！！！");
		label_3.setFont(new Font("宋体", Font.PLAIN, 25));
		label_3.setBounds(505, 62, 246, 80);
